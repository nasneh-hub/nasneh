...
|------|-------|----------|--------|
| 12:43:41 | Fixed (customer-web): remove duplicate /api/v1 prefix in Add to Cart | PR #311 | @nasneh-hub |
...
| 10:01:16 | Fixed (customer-web): remove mono classes from cart components [S6-01 PR1] | PR #295 | @nasneh-hub |
| 07:50:09 | Added (dashboard): add application detail page with review actions [S5-05 PR4] | PR #294 | @nasneh-hub |
...
| Time | Event | Evidence | Author |
|------|-------|----------|--------|
| 20:11:09 | Added (orders): add order confirmation page with mock payment adapter for S5-02 PR5 | PR #267 | @nasneh-hub |
...
| 19:15:34 | Added (copy): add cart/checkout/order copy tokens for S5-02 | PR #262 | @nasneh-hub |
| 19:07:20 | Added (ui): add RadioGroup and Textarea components | PR #261 | @nasneh-hub |
